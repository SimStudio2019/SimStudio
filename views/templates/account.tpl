...
<div class="container bton">
	...
	<div class="row boutn align-items-start justify-content-center">
		...
		<div class="col-md-6 pb-2">
			<a href="{$base}/compte/modeles" class="btn-link"><button class="btn btn-primary button2 buttonmoncompte ml-md-2 mr-md-2  btn-lg "><h4><strong>MES MODÈLES</strong></h4></button></a>
		</div>
	</div>
</div>
{/block}