		...
		<header class="">
			<div class="container">
				<div class="logo float-left">
					{block name="logo"}<a href="{$base}/compte"><img src="{$base}/img/logo-simstudio.png" alt="logo simstudio" class="img-fluid" /></a>{/block}
				</div>
				
				<nav class="nav-user float-right">
					{block name="nav-user"}
					<a href="{$base}/compte/profil" class="nav-item"><img src="{$base}/img/picto-account.png" alt="account" title="Mon compte" /></a>
