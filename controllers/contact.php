		...
		if(strlen($message) > 10)
		{
			...
			if ($resp->isSuccess()) {
				...
				$opt2 = array(
					'dest' => array(
						'name'	=> 'SimStudio',
						'email'	=> 'simstudio18@gmail.com'
					),
					'subject'	=> 'Message de '.$_SESSION['firstname'].' '.$_SESSION['name'],
					'template'	=> array(
						'html'	=> 'inc/emails/messageConfirmAdmin.html.php'
					),
					'var'		=> array(
						'firstname'	=> $_SESSION['firstname'],
						'name'		=> $_SESSION['name'],
				...
				if(send_mail($opt) && send_mail($opt2)){
